"""
================================================================================
MODULE NAME: OPM_MESA_Model

DESCRIPTION:
    Defines the full MESA-based agent-based model (ABM) for simulating the
    federal workforce. Includes agent scheduling, social network generation,
    salary dynamics, vacancies, promotions, retirements, and performance-driven
    behaviors.
