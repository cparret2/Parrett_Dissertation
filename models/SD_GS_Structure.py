"""
================================================================================
MODULE NAME: SD_GS_Structure

DESCRIPTION:
    System Dynamics model of a multi-grade General Schedule (GS) workforce
    structure. This module simulates workforce flows including recruitment,
    promotion, separations, retirements, and salary dynamics for GS-9 to GS-15
    levels. Developed as part of the dissertation research on computational
    approaches to human capital management in high-demand knowledge industries.
