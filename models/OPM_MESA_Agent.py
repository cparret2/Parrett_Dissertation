"""
================================================================================
MODULE NAME: OPM_MESA_Agent

DESCRIPTION:
    Extends the base OPM_Agent with MESA agent-based modeling integration.
    Includes influence calculation, behavioral preferences, and social network
    interactions for each agent in the simulation.
