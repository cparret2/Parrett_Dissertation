"""
================================================================================
MODULE NAME: OPM_Agent

DESCRIPTION:
    Defines the base OPM_Agent class representing an individual agent in the
    workforce model. Includes agent attributes, state transitions, and reporting.
